...
const App = () => {
  ...
  return (
   ...
   { jobOpenings.map(function(elem,idx) {
        ...
        return <div key={idx}>
         <Card  company={elem.companyNam} logo={elem.brandLogo} post={elem.datePosted} role={elem.post} time={elem.tag1} type={elem.tag2} pay={elem.pay} location={elem.location}/>
        </div>
    })}
