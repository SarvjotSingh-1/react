...
<button
  ...
  className="flex items-center justify-center gap-2 w-full cursor-pointer bg-red-600 hover:bg-red-700 active:scale-95 transition transform duration-150 py-2 px-4 text-sm rounded-md font-semibold text-white shadow-sm"
>
